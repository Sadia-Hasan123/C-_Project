...
namespace BBMS
{
    public partial class ABnInsert : Form
    {
        ...
        private void ABnInsert_Load(object sender, EventArgs e)
        {
            autoId();
        }
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Select count(BloodID) from ABnTable", con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Insert into ABnTable(BloodID,DonorId,Price,Date,ExpireDate)Values('" + textBox2.Text + "','" + textBox1.Text + "','" + textBox3.Text + "','" + dateTimePicker1.Text + "','" + dateTimePicker2.Text + "')", con);
                cmd.ExecuteNonQuery();
        ...
        private void ABnInsert_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
