...
namespace BBMS
{
    public partial class BnInsert : Form
    {
        ...
        private void BnInsert_Load(object sender, EventArgs e)
        {
            autoId();
        }
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Select count(BloodID) from BnTable", con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try { 
            con.Open();
            SqlCommand cmd = new SqlCommand("Insert into BnTable(BloodID,DonorId,Price,Date,ExpireDate)Values('" + textBox2.Text + "','" + textBox1.Text + "','" + textBox3.Text + "','" + dateTimePicker1.Text + "','" + dateTimePicker2.Text + "')", con);
            cmd.ExecuteNonQuery();
        ...
        private void BnInsert_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
