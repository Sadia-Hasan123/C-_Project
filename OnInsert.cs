...
namespace BBMS
{
    public partial class OnInsert : Form
    {
        ...
        private void OnInsert_Load(object sender, EventArgs e)
        {
            autoId();
        }
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Select count(BloodID) from OnTable", con);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try { 
            con.Open();
            SqlCommand cmd = new SqlCommand("Insert into OnTable(BloodID,DonorId,Price,Date,ExpireDate)Values('" + textBox2.Text + "','" + textBox1.Text + "','" + textBox3.Text + "','" + dateTimePicker1.Text + "','" + dateTimePicker2.Text + "')", con);
            cmd.ExecuteNonQuery();
        ...
        private void OnInsert_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
