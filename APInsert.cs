...
namespace BBMS
{
    public partial class APInsert : Form
    {
        ...
        int s = 11000;
        string a = "AP";
        private void APInsert_Load(object sender, EventArgs e)
        {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Select count(BloodID) from ApTable", con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Insert into ApTable(BloodID,DonorId,Price,Date,ExpireDate)Values('" + textBox2.Text + "','" + textBox1.Text + "','" + textBox3.Text + "','" + dateTimePicker1.Text + "','" + dateTimePicker2.Text + "')", con);
                cmd.ExecuteNonQuery();
        ...
        private void APInsert_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
