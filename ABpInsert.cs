...
namespace BBMS
{
    public partial class ABpInsert : Form
    {
        ...
        private void ABpInsert_Load(object sender, EventArgs e)
        {
            autoId();
        }
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Select count(BloodID) from ABpTable", con);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Insert into ABpTable(BloodID,DonorId,Price,Date,ExpireDate)Values('" + textBox2.Text + "','" + textBox1.Text + "','" + textBox3.Text + "','" + dateTimePicker1.Text + "','" + dateTimePicker2.Text + "')", con);
                cmd.ExecuteNonQuery();
        ...
        private void ABpInsert_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
